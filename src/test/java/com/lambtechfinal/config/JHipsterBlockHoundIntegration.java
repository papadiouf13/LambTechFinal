package com.lambtechfinal.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.lambtechfinal.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.lambtechfinal.security.DomainUserDetailsService", "createSpringSecurityUser");
